...
const InstructorAbout: React.FC<InstructorAboutProps> = ({
  bio,
  languages,
  joinedDate,
  socialLinks
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-lg font-medium mb-3">Languages I Speak</h3>
      ...
      <div className="py-4 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400">
        <p>Instructor since {joinedDate}</p>
      </div>
    </div>
  );
};
